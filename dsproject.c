...
node *main_logs(node *start)
{
    ...
    Sleep(500);
    printf("    \t ********So Plz Enter Your choice********\n\n\n");
    int T;
    scanf("%d",&T);
    if(T==1)
    {
...
int *z;
 z = &UNIVERSAL;
     ...
     while(temp!=NULL)
     {
         if((strcmp(temp->aadhar,"1")==0&& strcmp(temp->name,"bharath")==0 &&strcmp(temp->birth_date,"17-02-2004")==0) ||
         (strcmp(temp->aadhar,"2")==0&& strcmp(temp->name,"rayan")==0 &&strcmp(temp->birth_date,"28-01-2003")==0)||
         (strcmp(temp->aadhar,"3")==0&& strcmp(temp->name,"abhi")==0 &&strcmp(temp->birth_date,"11-08-2002")==0)||
         (strcmp(temp->aadhar,"4")==0&& strcmp(temp->name,"naveen")==0 &&strcmp(temp->birth_date,"13-07-2000")==0)||
         (strcmp(temp->aadhar,"5")==0&& strcmp(temp->name,"5")==0 &&strcmp(temp->birth_date,"5")==0)||
         (strcmp(temp->aadhar,"6")==0&& strcmp(temp->name,"6")==0 &&strcmp(temp->birth_date,"6")==0)||
         (strcmp(temp->aadhar,"7")==0&& strcmp(temp->name,"7")==0 &&strcmp(temp->birth_date,"7")==0)||
         (strcmp(temp->aadhar,"8")==0&& strcmp(temp->name,"8")==0 &&strcmp(temp->birth_date,"8")==0)||
         (strcmp(temp->aadhar,"9")==0&& strcmp(temp->name,"9")==0 &&strcmp(temp->birth_date,"9")==0)||
         (strcmp(temp->aadhar,"10")==0&& strcmp(temp->name,"10")0 &&strcmp(temp->birth_date,"10")==0))
...
void voting()
{
    ...
    Sleep(300);
    printf("\t\t\t 1.RAYAN                1.Fish\n");
    Sleep(300);
    printf("\t\t\t 2.ABHISHEK             2.Boat\n");
    Sleep(300);
    printf("\t\t\t 3.NAVEEN               3.Motorcycle\n");
    Sleep(300);
    printf("\t\t\t 4.BHARATH              4.Broomstick\n");
    Sleep(300);
    printf("\t\t\t 5.EMPTY                5.Wheel\n\n\n");
       ...
       for(j=1;j<=1;j++)
       {
           ...
           {
               vote1++;
               printf("\n\n\t\t\t\tYOU HAVE SUCCESSFULLY GIVEN YOUR VOTE TO RAYAN\n");
               break;
           ...
           {
               vote2++;
                printf("\n\n\t\t\t\tYOU HAVE SUCCESSFULLY GIVEN YOUR VOTE TO ABHISHEK\n");
               break;
           ...
           {
               vote3++;
                printf("\n\n\t\t\t\tYOU HAVE SUCCESSFULLY GIVEN YOUR VOTE TO NAVEEN\n");
               break;
           ...
           {
               vote4++;
                printf("\n\n\t\t\t\tYOU HAVE SUCCESSFULLY GIVEN YOUR VOTE TO BHARATH\n");
               break;
           }
           if(B==5)
           {
               vote5++;
                printf("\n\n\t\t\t\tYOU HAVE SUCCESSFULLY GIVEN YOUR VOTE TO EMPTY\n");
               break;
           }
 ...
 void admin()
 {
  ...
  void show()
  {
      ...
      Sleep(500);
      printf("\t\t\t  RAYAN is on          %d Votes\n",vote1);
      Sleep(500);
      printf("\t\t\t  ABHISHEK  is on      %d Votes\n",vote2);
      Sleep(500);
      printf("\t\t\t  NAVEEN is on         %d Votes\n",vote3);
      Sleep(500);
      printf("\t\t\t  BHARATH is on        %d Votes\n",vote4);
      Sleep(500);
      printf("\t\t\t  EMPTY is on          %d Votes\n\n\n\n",vote5);
      Sleep(500);
   ...
   void winner()
   {
       ...
       if(vote2<vote1 && vote3< vote1 && vote4<vote1 && vote5<vote1)
        printf("\t\t\tThe present Winner is RAYAN and he has got %d votes\n\n\n\n",vote1);

       if(vote1<vote2 && vote3< vote2 && vote4<vote2 && vote5<vote2)
        printf("\t\t\tThe present Winner is ABHISHEK and he has got %d votes\n\n\n\n",vote2);

        if(vote1<vote3 && vote2< vote3 && vote4<vote3 && vote5<vote3)
        printf("\t\t\tThe present Winner is NAVEEN and he has got %d votes\n\n\n\n",vote3);

        if(vote1<vote4 && vote2< vote4 && vote3<vote4 && vote5<vote4)
        printf("\t\t\tThe present Winner is BHARATH and he has got %d votes\n\n\n\n",vote4);

        if(vote1<vote5 && vote2< vote5 && vote3<vote5 && vote4<vote5)
        printf("\t\t\tThe present Winner is EMPTY and he/she has got %d votes\n\n\n\n",vote5);
